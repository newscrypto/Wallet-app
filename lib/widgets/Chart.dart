...
class SimpleTimeSeriesChart extends StatelessWidget {
  ...
  static List<charts.Series<TimeSeriesSales, DateTime>> _createSampleData() {
    final data = [
      new TimeSeriesSales(new DateTime(2020, 8, 1), 5),
      new TimeSeriesSales(new DateTime(2020, 8, 2), 5),
      new TimeSeriesSales(new DateTime(2020, 8, 3), 5),
      new TimeSeriesSales(new DateTime(2020, 8, 4), 5),
      new TimeSeriesSales(new DateTime(2020, 8, 5), 5),
      new TimeSeriesSales(new DateTime(2017, 9, 6), 25),
    ];
